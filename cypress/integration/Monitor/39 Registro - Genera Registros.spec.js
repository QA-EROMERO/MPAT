describe('TC025 Registro - Genera Registros', () => {

    //..Mantenimiento Expiracion de registro
    it('Registros - Genera Registros', () =>{
        cy.LogIn()
        
        //..Constantes
        const MTE = 'Registros'
        const Codigo = '3784'
        const Nombre = 'MPAT_Registro - Genera Registro ' + Codigo
        ...
        cy.addBasicNumericField(1,'MPAT_Campo 1 - Genera Registro',8,2)

        //..Agregar un campo básico de tipo Alfanumérico.
        //..Código de Campo, Nombre del Campo, longitud
        cy.addBasicAlphanumericField(2,'MPAT_Campo 2 - Genera Registro',20)

        //..Agregar un campo básico de tipo Numérico.
        cy.addBasicNumericField(3,'MPAT_Campo 3 - Genera Registro',6,4)

        //..Agregar un campo básico de tipo Alfanumérico.
        cy.addBasicAlphanumericField(4,'MPAT_Campo 4 - Genera Registro',25)
